...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.pledge_type'
        db.add_column(u'publicweb_pledge', 'pledge_type',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pledge.pledge_type'
        db.delete_column(u'publicweb_pledge', 'pledge_type')
    ...
    models = {
        ...
        u'publicweb.ecoeligible': {
            'Meta': {'object_name': 'EcoEligible'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'publicweb.homepagechecklist': {
            'Meta': {'object_name': 'HomepageCheckList'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'publicweb.organisation': {
            'Meta': {'object_name': 'Organisation'},
            'description': ('django.db.models.fields.TextField', [], {'default': "'No description available.'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'organisation_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        u'publicweb.pledge': {
            'Meta': {'object_name': 'Pledge'},
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
            ...
            'pledge_type': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
        ...
        u'publicweb.toptip': {
            ...
            'display_on_welcome_screen': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
