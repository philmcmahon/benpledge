...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dwelling.house_id'
        db.add_column(u'publicweb_dwelling', 'house_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dwelling.house_id'
        db.delete_column(u'publicweb_dwelling', 'house_id')
