...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Area.area_name'
        db.alter_column(u'publicweb_area', 'area_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Area.area_name'
        db.alter_column(u'publicweb_area', 'area_name', self.gf('django.db.models.fields.CharField')(max_length=30))
