...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HatMetaData'
        db.create_table(u'publicweb_hatmetadata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('variable', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'publicweb', ['HatMetaData'])


    def backwards(self, orm):
        # Deleting model 'HatMetaData'
        db.delete_table(u'publicweb_hatmetadata')
