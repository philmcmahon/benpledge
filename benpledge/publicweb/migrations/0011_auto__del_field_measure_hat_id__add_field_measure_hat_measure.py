...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Measure.hat_id'
        db.delete_column(u'publicweb_measure', 'hat_id')

        # Adding field 'Measure.hat_measure'
        db.add_column(u'publicweb_measure', 'hat_measure',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['publicweb.HatMeasuresList'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Measure.hat_id'
        db.add_column(u'publicweb_measure', 'hat_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Measure.hat_measure'
        db.delete_column(u'publicweb_measure', 'hat_measure_id')
