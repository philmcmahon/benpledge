...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.hat_results'
        db.add_column(u'publicweb_pledge', 'hat_results',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicweb.HatResultsDatabase'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pledge.hat_results'
        db.delete_column(u'publicweb_pledge', 'hat_results_id')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
