...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dwelling.number_of_inhabitants'
        db.add_column(u'publicweb_dwelling', 'number_of_inhabitants',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.gas_spend_per_month'
        db.add_column(u'publicweb_userprofile', 'gas_spend_per_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.electricity_spend_per_month'
        db.add_column(u'publicweb_userprofile', 'electricity_spend_per_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.gas_provider'
        db.add_column(u'publicweb_userprofile', 'gas_provider',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.electricity_provider'
        db.add_column(u'publicweb_userprofile', 'electricity_provider',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dwelling.number_of_inhabitants'
        db.delete_column(u'publicweb_dwelling', 'number_of_inhabitants')

        # Deleting field 'UserProfile.gas_spend_per_month'
        db.delete_column(u'publicweb_userprofile', 'gas_spend_per_month')

        # Deleting field 'UserProfile.electricity_spend_per_month'
        db.delete_column(u'publicweb_userprofile', 'electricity_spend_per_month')

        # Deleting field 'UserProfile.gas_provider'
        db.delete_column(u'publicweb_userprofile', 'gas_provider')

        # Deleting field 'UserProfile.electricity_provider'
        db.delete_column(u'publicweb_userprofile', 'electricity_provider')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
