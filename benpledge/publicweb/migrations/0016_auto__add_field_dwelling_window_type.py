...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dwelling.window_type'
        db.add_column(u'publicweb_dwelling', 'window_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dwelling.window_type'
        db.delete_column(u'publicweb_dwelling', 'window_type')
