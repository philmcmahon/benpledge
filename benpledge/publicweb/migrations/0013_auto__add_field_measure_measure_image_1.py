...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Measure.measure_image_1'
        db.add_column(u'publicweb_measure', 'measure_image_1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Measure.measure_image_1'
        db.delete_column(u'publicweb_measure', 'measure_image_1')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)'}),
