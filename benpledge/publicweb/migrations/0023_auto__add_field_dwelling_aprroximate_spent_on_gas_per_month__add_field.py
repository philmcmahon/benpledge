...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dwelling.aprroximate_spent_on_gas_per_month'
        db.add_column(u'publicweb_dwelling', 'aprroximate_spent_on_gas_per_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dwelling.approximate_spent_on_electricity_per_month'
        db.add_column(u'publicweb_dwelling', 'approximate_spent_on_electricity_per_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dwelling.gas_supplier'
        db.add_column(u'publicweb_dwelling', 'gas_supplier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dwelling.electricity_supplier'
        db.add_column(u'publicweb_dwelling', 'electricity_supplier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dwelling.aprroximate_spent_on_gas_per_month'
        db.delete_column(u'publicweb_dwelling', 'aprroximate_spent_on_gas_per_month')

        # Deleting field 'Dwelling.approximate_spent_on_electricity_per_month'
        db.delete_column(u'publicweb_dwelling', 'approximate_spent_on_electricity_per_month')

        # Deleting field 'Dwelling.gas_supplier'
        db.delete_column(u'publicweb_dwelling', 'gas_supplier')

        # Deleting field 'Dwelling.electricity_supplier'
        db.delete_column(u'publicweb_dwelling', 'electricity_supplier')
