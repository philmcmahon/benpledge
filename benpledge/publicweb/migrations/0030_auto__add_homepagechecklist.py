...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomepageCheckList'
        db.create_table(u'publicweb_homepagechecklist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'publicweb', ['HomepageCheckList'])


    def backwards(self, orm):
        # Deleting model 'HomepageCheckList'
        db.delete_table(u'publicweb_homepagechecklist')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
