...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.receive_updates'
        db.add_column(u'publicweb_pledge', 'receive_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pledge.receive_updates'
        db.delete_column(u'publicweb_pledge', 'receive_updates')
