...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LsoaDomesticEnergyConsumption'
        db.create_table(u'publicweb_lsoadomesticenergyconsumption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('la_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('msoa_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('msoa_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('lsoa_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('lsoa_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('total_electricity_and_gas_consumption_mwh', self.gf('django.db.models.fields.IntegerField')()),
            ('ordinary_electricity_consumption_mwh', self.gf('django.db.models.fields.IntegerField')()),
            ('economy_7_electricity_consumption_mwh', self.gf('django.db.models.fields.IntegerField')()),
            ('gas_consumption_mwh', self.gf('django.db.models.fields.IntegerField')()),
            ('number_of_ordinary_electricity_meters', self.gf('django.db.models.fields.IntegerField')()),
            ('average_ordinary_electricity_consumption_kwh', self.gf('django.db.models.fields.IntegerField')()),
            ('number_of_economy_7_electricity_meters', self.gf('django.db.models.fields.IntegerField')()),
            ('average_economy_7_electricity_consumption_kwh', self.gf('django.db.models.fields.IntegerField')()),
            ('number_domestic_gas_meters', self.gf('django.db.models.fields.IntegerField')()),
            ('average_domestic_gas_consumption_kwh', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'publicweb', ['LsoaDomesticEnergyConsumption'])

        # Adding model 'PostcodeOaLookup'
        db.create_table(u'publicweb_postcodeoalookup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('postcode', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('oa_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('lsoa_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('lsoa_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('msoa_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('la_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
        ))
        db.send_create_signal(u'publicweb', ['PostcodeOaLookup'])


    def backwards(self, orm):
        # Deleting model 'LsoaDomesticEnergyConsumption'
        db.delete_table(u'publicweb_lsoadomesticenergyconsumption')

        # Deleting model 'PostcodeOaLookup'
        db.delete_table(u'publicweb_postcodeoalookup')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
