...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dwelling.area'
        db.add_column(u'publicweb_dwelling', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicweb.Area'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.area'
        db.delete_column(u'publicweb_userprofile', 'area_id')


    def backwards(self, orm):
        # Deleting field 'Dwelling.area'
        db.delete_column(u'publicweb_dwelling', 'area_id')

        # Adding field 'UserProfile.area'
        db.add_column(u'publicweb_userprofile', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicweb.Area'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)'}),
