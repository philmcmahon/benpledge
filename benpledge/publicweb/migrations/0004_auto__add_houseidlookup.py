...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HouseIdLookup'
        db.create_table(u'publicweb_houseidlookup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dwelling_type', self.gf('django.db.models.fields.IntegerField')()),
            ('property_age', self.gf('django.db.models.fields.IntegerField')()),
            ('number_of_bedrooms', self.gf('django.db.models.fields.IntegerField')()),
            ('heating_fuel', self.gf('django.db.models.fields.IntegerField')()),
            ('heating_type', self.gf('django.db.models.fields.IntegerField')()),
            ('loft_insulation', self.gf('django.db.models.fields.IntegerField')()),
            ('wall_type', self.gf('django.db.models.fields.IntegerField')()),
            ('index_id', self.gf('django.db.models.fields.IntegerField')()),
            ('house_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'publicweb', ['HouseIdLookup'])


    def backwards(self, orm):
        # Deleting model 'HouseIdLookup'
        db.delete_table(u'publicweb_houseidlookup')
