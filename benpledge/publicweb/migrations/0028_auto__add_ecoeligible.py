...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EcoEligible'
        db.create_table(u'publicweb_ecoeligible', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lsoa_code', self.gf('django.db.models.fields.CharField')(max_length=9)),
        ))
        db.send_create_signal(u'publicweb', ['EcoEligible'])


    def backwards(self, orm):
        # Deleting model 'EcoEligible'
        db.delete_table(u'publicweb_ecoeligible')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 28, 0, 0)'}),
