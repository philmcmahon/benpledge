...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopTip.display_on_welcome_screen'
        db.add_column(u'publicweb_toptip', 'display_on_welcome_screen',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopTip.display_on_welcome_screen'
        db.delete_column(u'publicweb_toptip', 'display_on_welcome_screen')
