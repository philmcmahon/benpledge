...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HatResultsDatabase'
        db.create_table(u'publicweb_hatresultsdatabase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('index', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('house_id', self.gf('django.db.models.fields.IntegerField')()),
            ('m1', self.gf('django.db.models.fields.IntegerField')()),
            ('current_sap_rating', self.gf('django.db.models.fields.FloatField')()),
            ('post_measure_sap_rating', self.gf('django.db.models.fields.FloatField')()),
            ('sap_change', self.gf('django.db.models.fields.FloatField')()),
            ('current_energy_consumption_kwh', self.gf('django.db.models.fields.FloatField')()),
            ('post_measure_energy_consumption_kwh', self.gf('django.db.models.fields.FloatField')()),
            ('consumption_change', self.gf('django.db.models.fields.IntegerField')()),
            ('current_energy_costs', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('post_measure_energy_costs', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('annual_cost_reduction', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('current_co2_emissions_kgco2', self.gf('django.db.models.fields.FloatField')()),
            ('post_measure_co2_emissions_kgco2', self.gf('django.db.models.fields.FloatField')()),
            ('annual_co2_reduction', self.gf('django.db.models.fields.FloatField')()),
            ('approximate_installation_costs', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('grean_deal', self.gf('django.db.models.fields.BooleanField')()),
            ('eco_finance', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'publicweb', ['HatResultsDatabase'])

        # Adding field 'Pledge.date_made'
        db.add_column(u'publicweb_pledge', 'date_made',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HatResultsDatabase'
        db.delete_table(u'publicweb_hatresultsdatabase')

        # Deleting field 'Pledge.date_made'
        db.delete_column(u'publicweb_pledge', 'date_made')
