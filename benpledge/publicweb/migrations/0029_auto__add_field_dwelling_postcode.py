...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dwelling.postcode'
        db.add_column(u'publicweb_dwelling', 'postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dwelling.postcode'
        db.delete_column(u'publicweb_dwelling', 'postcode')
    ...
    models = {
        ...
        u'publicweb.pledge': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 29, 0, 0)'}),
