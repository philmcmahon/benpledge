...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HatMeasuresList'
        db.create_table(u'publicweb_hatmeasureslist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('measure_id', self.gf('django.db.models.fields.IntegerField')()),
            ('measure_name', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('measure_description', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('measure_category', self.gf('django.db.models.fields.CharField')(max_length=11, null=True)),
            ('measure_lifetime', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('measure_comfort_factor', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal(u'publicweb', ['HatMeasuresList'])


    def backwards(self, orm):
        # Deleting model 'HatMeasuresList'
        db.delete_table(u'publicweb_hatmeasureslist')
